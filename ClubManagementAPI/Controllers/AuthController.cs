...
namespace ClubManagementAPI.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Login(UserForLoginDto userForLoginDto)
        {
            ...
            {
                //Example
                //var appUser = await _userManager.Users.Include(p => p.Photos).FirstOrDefaultAsync(x => x.UserName == username);
                ...
                //Generate JwtToken Async 


                return Ok(new
                {
                    token = Task.WhenAll(GenerateJwtTokenAsync(user)).Result,
                    user = userToReturn
                });
            }
